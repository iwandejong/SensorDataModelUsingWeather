...
class SensorModel:
    ...
    def train(self):
        ...
        # Save models
        best_model_1.save_model('soil_moisture_model.json')
        best_model_2.save_model('soil_temperature_model.json')
    ...
    def predict(self, temperature, humidity):
        ...
        model_1.load_model('soil_moisture_model.json')

        model_2 = xgb.XGBRegressor()
        model_2.load_model('soil_temperature_model.json')
...
if __name__ == '__main__':
    ...
    # Example prediction
    y1_pred, y2_pred = model.predict(25, 70)